...
def load_scenario_yaml(
    ...
    *,
    ...
    tests/evals/ (NOT tests/evals/logs/) — the YAML's `logs.dir` field
    (default "logs") is resolved relative to it, matching every scenario's
    convention of naming the SAME shared logs/ folder regardless of which
    ...
    return LiveScenario(
        ...
        logs_dir=logs_root / logs_spec.get("dir", "logs"),
