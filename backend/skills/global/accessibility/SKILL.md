---
name: accessibility
display_name: Accessibility (WCAG 2.2)
description: Design, implement, and audit WCAG 2.2 AA accessibility for Web and native apps. Use for ARIA roles, contrast, and focus order when building or reviewing UI components.
category: planning
isBeta: false
tags:
- accessibility
