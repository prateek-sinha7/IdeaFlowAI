...
display_name: Java Coding Standards
category: collaboration
description: "Java 17+ standards for Spring Boot and Quarkus: naming, immutability, Optional/streams, exceptions, generics, CDI, reactive patterns, auto-detected per framework. Use when writing Java services."
tags:
- java
- coding
- standards
