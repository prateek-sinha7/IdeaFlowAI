...
display_name: SEO
category: planning
description: Audit and implement technical SEO, on-page optimization, structured data, Core Web Vitals, and keyword-to-URL mapping. Use for better search visibility or sitemap/robots work.
tags:
- seo
---
