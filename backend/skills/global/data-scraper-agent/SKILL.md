...
display_name: Data Scraper Agent
category: workflow
description: Build a scheduled, LLM-enriched data-collection agent (Gemini Flash + GitHub Actions) that scrapes any public source into Notion/Sheets/Supabase. Use to monitor public data automatically.
tags:
- data
- scraper
- agent
