...
display_name: Quarkus Development Patterns
category: workflow
description: "Quarkus 3.x LTS patterns: JAX-RS/RESTEasy Reactive APIs, CDI services, Panache data access, Camel messaging, async processing for event-driven Java backends. Use for Quarkus services."
tags:
- quarkus
- patterns
---
