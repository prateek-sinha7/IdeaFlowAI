...
category: planning
description: Capture architectural decisions made during a session as structured ADRs with context, alternatives, and rationale. Use when a significant tech choice is made or when asked why.
tags:
- architecture
- decision
- records
