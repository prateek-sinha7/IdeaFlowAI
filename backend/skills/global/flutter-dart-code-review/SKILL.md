...
display_name: Flutter/Dart Code Review Best Practices
category: planning
description: "Library-agnostic Flutter/Dart review checklist: widget structure, state management (BLoC/Riverpod/Provider/GetX), Dart idioms, performance, security. Use when reviewing a Flutter/Dart PR."
tags:
- flutter
- dart
- code
...
- [ ] Route paths definedants, enums, or generated — no magic strings scattered in code
