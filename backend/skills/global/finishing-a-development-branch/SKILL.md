...
**If worktree path is under `.worktrees/`, `worktrees/`, or `~/.config/this-skill/worktrees/`:** This skill created this worktree — we own cleanup.
...
- **Fix:** Only clean up worktrees under `.worktrees/`, `worktrees/`, or `~/.config/this-skill/worktrees/`
