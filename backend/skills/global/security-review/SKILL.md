...
category: security
description: Security checklist and patterns for authentication, user input handling, secrets, new API endpoints, and payment features. Use when implementing security-sensitive code.
tags:
- security
- owasp
- sast
