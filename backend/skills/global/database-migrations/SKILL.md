...
display_name: Database Migration Patterns
category: testing
description: Database migration practices for schema changes, data backfills, rollbacks, and zero-downtime deploys across PostgreSQL, MySQL, and ORMs like Prisma or Django. Use when altering tables or indexes.
tags:
- database
- migrations
---
