---
name: fal-ai-media
display_name: fal.ai Media Generation
category: planning
description: Generate images, video, and audio via the fal.ai MCP server (Nano Banana, Seedance, Kling, Veo 3, CSM-1B, ThinkSound). Use when generating or editing media with AI and fal.ai MCP is configured.
tags:
- fal
- media
---
...
fal.ai MCP server must be configured. Add to your MCP client configuration:
