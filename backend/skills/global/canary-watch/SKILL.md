---
name: canary-watch
display_name: Canary Watch — Post-Deploy Monitoring
category: workflow
description: Monitor a deployed URL for HTTP errors, console errors, SSE stream health, and performance regressions. Use after deploys, risky merges, or dependency upgrades to verify nothing broke.
tags:
- canary
- watch
---
...
- Log to `~/.canary-watch/canary-watch.log`
