---
name: vite-patterns
display_name: Vite Patterns
category: debugging
description: "Vite 8+ build tool patterns: config, plugins, HMR, env variables, dev server proxy, SSR, library mode, dependency pre-bundling. Use when working with vite.config.ts or debugging Vite issues."
tags:
- vite
- patterns
---
