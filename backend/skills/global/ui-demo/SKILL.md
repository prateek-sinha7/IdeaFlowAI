---
name: ui-demo
display_name: UI Demo Video Recorder
category: testing
description: Record polished WebM UI demo videos with Playwright using a Discover-Rehearse-Record process with a cursor overlay and natural pacing. Use for a demo video, walkthrough, or tutorial recording.
tags:
- demo
---
