...
display_name: Healthcare PHI/PII Compliance Patterns
category: security
description: "PHI/PII protection patterns: data classification, access control, audit trails, encryption, and leak vectors (HIPAA, GDPR, DISHA). Use when a feature touches patient or clinician data."
tags:
- healthcare
- phi
- compliance
