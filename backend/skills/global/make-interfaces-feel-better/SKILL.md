...
category: planning
description: Apply design-engineering details, spacing, typography, borders, shadows, motion, hit areas, interaction states, that make an interface feel polished. Use when a UI feels flat or unfinished.
tags:
- make
- interfaces
- feel
