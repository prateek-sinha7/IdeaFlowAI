...
category: security
description: "Canonical entrypoint for US HIPAA compliance: PHI handling, covered entities, BAAs, breach posture, delegating detail to healthcare-phi-compliance. Use only when a task explicitly names HIPAA."
tags:
- hipaa
- compliance
---
