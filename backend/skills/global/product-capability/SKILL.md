...
category: planning
description: Turn a PRD, roadmap ask, or product discussion into an implementation-ready capability plan exposing constraints, invariants, interfaces, and open decisions. Use for multi-service features.
tags:
- product
- capability
---
...
If useful, point to the next lane:
...
- The resulting plan is reusable across different coding agents and planning surfaces.