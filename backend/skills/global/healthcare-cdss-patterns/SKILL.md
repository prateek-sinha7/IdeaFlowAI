...
display_name: Healthcare CDSS Development Patterns
category: testing
description: "Clinical Decision Support System patterns: drug interaction checks, dose validation, NEWS2/qSOFA scoring, alert severity as pure testable functions. Use when building CDSS logic for EMR workflows."
tags:
- healthcare
- cdss
- patterns
