...
display_name: Healthcare EMR Development Patterns
category: planning
description: "EMR/EHR development patterns: patient encounter workflows, prescription generation, CDSS integration, accessible clinical data entry UI. Use when building patient-record features."
tags:
- healthcare
- emr
- patterns
