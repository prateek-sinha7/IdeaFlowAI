...
category: debugging
description: "Manage GitHub repos via gh CLI: issue triage, PR merge readiness, CI/CD debugging, release prep, and Dependabot/security monitoring. Use for GitHub tasks beyond plain git commands."
tags:
- github
- ops
---
