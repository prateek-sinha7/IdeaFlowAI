...
category: planning
description: Build zero-dependency, animation-rich HTML slide decks from scratch or by converting PPT/PPTX. Use for a talk/pitch deck or converting existing slides to a self-contained web presentation.
tags:
- frontend
- slides
---
