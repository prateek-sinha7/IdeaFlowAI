...
display_name: Motion Foundations
category: debugging
description: Foundational motion tokens, spring presets, performance rules, prefers-reduced-motion, and SSR-safety for React/Next.js with motion/react. Load before any animated component or other motion skill.
tags:
- motion
- foundations
---
