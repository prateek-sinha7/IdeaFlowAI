---
name: code-tour
display_name: Code Tour
category: planning
description: Create CodeTour .tour JSON files, step-by-step walkthroughs anchored to real files and line ranges. Use for onboarding, architecture, PR, or RCA tours instead of flat Markdown summaries.
tags:
- code
- tour
---
