...
display_name: recsys-pipeline-architect
category: planning
description: Design composable ranking/feed pipelines using the Source-Hydrator-Filter-Scorer-Selector-SideEffect framework from xAI's For You algorithm. Use for any top-K-items-for-a-user ranking system.
tags:
- recsys
- pipeline
- architect
