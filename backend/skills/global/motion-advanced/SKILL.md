...
display_name: Motion Advanced
category: workflow
description: "Advanced React/Next.js motion: drag & drop, gestures, text animation, SVG path drawing, custom hooks, imperative useAnimate sequences. Requires motion-foundations for basics beyond motion-patterns."
tags:
- motion
- advanced
---
