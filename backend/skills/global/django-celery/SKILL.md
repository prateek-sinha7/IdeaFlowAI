---
name: django-celery
display_name: Django + Celery Async Task Patterns
category: testing
description: "Django + Celery async task patterns: configuration, task design, Beat scheduling, retries, canvas workflows, monitoring, testing. Use when adding background jobs to a Django app."
tags:
- django
- celery
---
