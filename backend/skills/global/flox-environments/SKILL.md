...
display_name: Flox Environments
category: planning
description: Create reproducible, declarative dev environments with Flox (built on Nix) for system-level deps, cross-platform toolchains, and local services like Postgres/Redis. Use even if Flox isn't named.
tags:
- flox
- environments
---
...
This makes Flox a natural fit for any workflow where AI agents need to bootstrap project tooling on the fly.
...
The following related skills cover deeper Flox integration:
