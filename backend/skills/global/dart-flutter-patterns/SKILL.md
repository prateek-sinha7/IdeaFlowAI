...
display_name: Dart/Flutter Patterns
category: testing
description: "Production Dart/Flutter patterns: null safety, immutable state, async composition, widget architecture, BLoC/Riverpod/Provider, GoRouter, Dio, Freezed. Use when writing or reviewing Flutter code."
tags:
- dart
- flutter
- patterns
