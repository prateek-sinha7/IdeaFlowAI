---
name: research-ops
display_name: Research Ops
category: workflow
description: Evidence-first operator workflow that coordinates exa-search, deep-research, market-research, and lead-intelligence for current-state research. Use for fresh, sourced facts or monitored research.
tags:
- research
- ops
---
...
Pull these related skills into the workflow when relevant:
