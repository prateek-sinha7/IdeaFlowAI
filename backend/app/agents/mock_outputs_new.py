...
- **Background:** #ffffff (Dark navy — professional, modern)
- **Text:** #141413 (Near-white — high contrast)
...
- Metric cards with large numbers and trend arrows""",
    ...
    "pitch-compiler": """{"slides":[{"title":"Documentation is killing your team's velocity","subtitle":"Product teams spend 40% of time writing, not building","content":[{"text":"15+ user stories written manually per sprint","subPoints":[]},{"text":"2-3 days to create a single pitch deck","subPoints":[]},{"text":"Weeks of iteration for UI prototypes","subPoints":[]},{"text":"$180K/year wasted per team on documentation","subPoints":[]}],"type":"text","layout":"centered","colorScheme":{"background":"#ffffff","text":"#141413","accent":"#3B82F6"},"speakerNotes":"Open with the pain every PM feels."},{"title":"$12.4B opportunity growing 34% YoY","subtitle":"AI productivity tools are the fastest-growing SaaS category","content":[{"text":"TAM: $12.4B global AI productivity","subPoints":[]},{"text":"SAM: $3.1B product/engineering teams","subPoints":[]},{"text":"67% of enterprises adopting agentic AI","subPoints":[]}],"type":"chart","layout":"split","colorScheme":{"background":"#ffffff","text":"#141413","accent":"#8B5CF6"},"speakerNotes":"The market timing is perfect.","chartData":{"type":"bar","labels":["TAM","SAM","SOM"],"values":[12.4,3.1,0.045],"title":"Market Size ($B)"}},{"title":"IdeaFlow AI — Idea to deliverable in 60 seconds","subtitle":"Specialist AI agents that think like your best team members","content":[{"text":"Describe any idea in plain English","subPoints":[]},{"text":"10-12 specialist agents collaborate","subPoints":[]},{"text":"Structured outputs: stories, decks, prototypes","subPoints":[]},{"text":"Customize pipelines to your workflow","subPoints":[]}],"type":"text","layout":"centered","colorScheme":{"background":"#ffffff","text":"#141413","accent":"#10B981"},"speakerNotes":"This is not a chatbot. It is a team of specialists."},{"title":"Path to $10M ARR in 24 months","subtitle":"High-margin SaaS with strong unit economics","content":[{"text":"$49/user/month Pro tier","subPoints":[]},{"text":"82% gross margin","subPoints":[]},{"text":"7.4x LTV:CAC ratio","subPoints":[]}],"type":"chart","layout":"split","colorScheme":{"background":"#ffffff","text":"#141413","accent":"#3B82F6"},"speakerNotes":"The economics work at scale.","chartData":{"type":"line","labels":["Q1","Q2","Q3","Q4","Q5","Q6","Q7","Q8"],"values":[0.1,0.3,0.6,1.2,2.1,3.4,4.8,5.8],"title":"ARR Projection ($M)"}},{"title":"Raising $3M to capture the market","subtitle":"18-month runway to 5,000 users and $100K MRR","content":[{"text":"60% Engineering — build the platform","subPoints":[]},{"text":"25% Go-to-Market — acquire users","subPoints":[]},{"text":"15% Operations — compliance, support","subPoints":[]}],"type":"text","layout":"centered","colorScheme":{"background":"#ffffff","text":"#141413","accent":"#8B5CF6"},"speakerNotes":"Clear use of funds with measurable milestones."}]}""",
