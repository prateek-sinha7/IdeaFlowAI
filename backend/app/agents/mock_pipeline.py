...
- Improvement: Add one more data point to slide 9""",
    ...
    "export-formatter": """{"slides":[{"title":"IdeaFlow AI Platform","subtitle":"Transform Ideas into Deliverables","content":[{"text":"AI-powered platform for product teams"},{"text":"From concept to structured output in minutes"}],"type":"title","layout":"title","colorScheme":{"background":"#ffffff","text":"#141413","accent":"#c96442"},"speakerNotes":"Welcome everyone. Today I am excited to introduce IdeaFlow AI, a platform that transforms raw product ideas into polished deliverables in minutes."},{"title":"The Problem We Solve","content":[{"text":"Product teams waste 40% of time on documentation"},{"text":"Requirements are ambiguous, causing costly rework"},{"text":"Creating presentations takes hours of formatting"},{"text":"UI prototyping requires expensive tools and skills"}],"type":"text","layout":"content","colorScheme":{"background":"#000000","text":"#141413","accent":"#c96442"},"speakerNotes":"Research shows product teams spend nearly half their time on documentation rather than building. The gap between idea and deliverable is where productivity dies."},{"title":"Market Opportunity","content":[{"text":"AI SaaS market projected to reach $95B by 2026"},{"text":"67% CAGR in AI-powered productivity tools"}],"type":"chart","layout":"chart","chartData":{"type":"bar","labels":["2022","2023","2024","2025","2026"],"values":[12,28,45,67,95],"title":"AI SaaS Market Growth ($B)"},"colorScheme":{"background":"#ffffff","text":"#141413","accent":"#4FC3F7"},"speakerNotes":"The AI SaaS market is experiencing explosive growth. We are positioned at the intersection of AI and productivity."},{"title":"Feature Comparison","content":[{"text":"IdeaFlow AI leads across all key capabilities"}],"type":"table","layout":"content","tableData":{"headers":["Feature","IdeaFlow AI","Competitor A","Competitor B"],"rows":[["User Stories","\\u2713 Full","Partial","\\u2717"],["PPT Generation","\\u2713 Full","\\u2717","Partial"],["Prototyping","\\u2713 Full","\\u2717","\\u2717"],["Real-time Streaming","\\u2713","\\u2717","\\u2713"],["Export to PPTX","\\u2713","\\u2717","\\u2717"]]},"colorScheme":{"background":"#000000","text":"#141413","accent":"#4FC3F7"},"speakerNotes":"When compared to competitors, IdeaFlow AI is the only platform offering full coverage across all deliverable types."},{"title":"Platform Architecture","content":[{"text":"Modern full-stack built for speed and reliability"}],"type":"two-column","layout":"two-column","columns":[["Next.js + TypeScript","Tailwind CSS + Motion","WebSocket streaming"],["FastAPI + Python","LangChain + Claude AI","SQLite / PostgreSQL"]],"colorScheme":{"background":"#ffffff","text":"#141413","accent":"#4FC3F7"},"speakerNotes":"Our architecture separates concerns cleanly. The frontend delivers a responsive experience while the backend orchestrates multiple AI agents."},{"title":"Target User Segments","content":[{"text":"Product Managers are our primary audience at 40%"}],"type":"chart","layout":"chart","chartData":{"type":"pie","labels":["Product Managers","Developers","Designers","Executives"],"values":[40,25,20,15],"title":"User Distribution"},"colorScheme":{"background":"#000000","text":"#141413","accent":"#4FC3F7"},"speakerNotes":"Our primary users are product managers who need to quickly generate structured deliverables."},{"title":"Before vs After","content":[{"text":"Dramatic reduction in time-to-deliverable"}],"type":"comparison","layout":"comparison","comparisonData":{"left":{"title":"Before","items":["4+ hours writing user stories","Full day creating presentations","Weeks for UI prototypes","Inconsistent documentation"]},"right":{"title":"After","items":["5 minutes with AI generation","Instant slide deck creation","Real-time prototype preview","Standardized professional output"]}},"colorScheme":{"background":"#ffffff","text":"#141413","accent":"#4FC3F7"},"speakerNotes":"The transformation is dramatic. Tasks that took hours now complete in minutes."},{"title":"Next Steps","content":[{"text":"Launch closed beta with 20 enterprise teams Q2 2025"},{"text":"Integrate with Jira, Confluence, and Notion"},{"text":"Add team collaboration with real-time co-editing"},{"text":"Expand AI models for domain-specific generation"}],"type":"text","layout":"content","colorScheme":{"background":"#ffffff","text":"#141413","accent":"#c96442"},"speakerNotes":"Our roadmap focuses on enterprise adoption and integrations. We are targeting Q2 2025 for our closed beta."}]}""",
}
