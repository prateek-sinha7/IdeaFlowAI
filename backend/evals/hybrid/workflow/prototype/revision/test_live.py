...
Run via ``./evals/hybrid/eval.sh <scenario-id> --live`` (e.g. ``./evals/hybrid/eval.sh
prototype_multi_issue_repair --live``), or directly: ``pytest
evals/hybrid/workflow/prototype/revision/test_live.py -m "eval and
...
``validate_scenario.py``/``./evals/hybrid/eval.sh <id>`` already covers "does this
...
from evals.hybrid.common.scenario_discovery import discover_scenarios_in
from evals.hybrid.workflow.prototype.revision.checkers import CHECKERS
