...
output "fqdn" {
  description = "Public FQDN the app is reachable on."
  value       = module.dns.fqdn
}

output "parameter_path_prefix" {
  description = "SSM Parameter Store prefix Flowin reads from."
  value       = module.secrets.parameter_path_prefix
}

output "resource_group_all" {
  description = "Top-level Resource Group covering every Flowin resource in this environment."
