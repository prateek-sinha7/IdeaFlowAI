...
description: GitHub dark purple-gradient deck — GitHub-dark #0d1117 background + purple-blue radial ambient glow + 60px grid mask, centered layout, purple pill tags, tri-color gradient headline (#a855f7→#60a5fa→#34d399), GitHub-style code palette, purple left-border highlight blocks. Suited for developer workflow / MCP / Agent / dev tool tutorials, similar to GitHub Blog / Linear Changelog.
triggers:
  - "github dark"
  - "developer tutorial"
  - "mcp tutorial"
...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "Use the html-ppt-obsidian-claude-gradient template to make a developer tutorial deck. GitHub dark purple gradient + centered layout + purple pills + tri-color gradient headline + config/step code blocks. First confirm: what topic, target audience, and whether to include an MCP/Agent config example."
---
