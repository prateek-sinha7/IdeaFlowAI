...
description: Dark-background knowledge graph deck — #06060c→#0e1020 midnight gradient + floating blur orbs, cover SVG force-directed graph, rainbow gradient title, JetBrains Mono command-line highlighting, glass-morphism cards. Suited to dev-tool / CLI / knowledge graph / data visualization launch events, an "AI-native + sci-fi + warm-tone" mood.
triggers:
  - "knowledge graph"
  - "graph deck"
  - "dark graph"
...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "Use the html-ppt-graphify-dark-graph template to build a dev-tool launch deck. Midnight gradient background + force-directed graph cover + rainbow title + JetBrains Mono command line. First confirm: tool name, core capabilities, demo steps; whether to type CLI commands live."
---
# HTML PPT · Dark-Background Knowledge Graph
