...
neutral wording such as `you`, `your`, `current user`, `I`, or `the reader`.
...
4. **Page header inside content column** — emoji icon (60px) at top,
   then page title `Daily Briefing · May 6, 2026 (Wed)` in 40px bold,
...
8. **Callout block** — required. `gray bg`, 16px padding, rounded 6px,
   ...
   *"You still have 3 unanswered comments from yesterday — take a look before Wednesday's meeting?"*
...
| Use lorem ipsum | Write real-shaped Notion copy: doc titles like `Q3 OKR`, `Onboarding Doc`, `Team Weekly Report`; people like Marie / Bob / Lily; comments like "This section needs your sign-off" |
