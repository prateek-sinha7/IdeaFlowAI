...
- **Source inspiration:** `20260409 upgraded knowledge base/Xiaohongshu image posts/v2-white-background/slide_01_cover.html` + `20260412-AI testing and safety/html/xhs-ai-testing-safety-v2.html`
...
- **When to use:** dual-purpose XHS (Xiaohongshu/RED) image post + horizontal deck; dense text with strong emphasis; Chinese-first audience.
...
## 3. knowledge-arch-blueprint — cream-toned blueprint architecture
...
## 6. testing-safety-alert — red-amber warning
...
- **Source inspiration:** `20260412-obsidian-skills/html/xhs-obsidian-skills.html` + pastel patterns shared with `20260409` v2-white-background
...
## 8. dir-key-nav-minimal — arrow-key 8-color minimal

- **Source inspiration:** `20260405-Karpathy-knowledge-base/20260405 presentation-slides [arrow-key edition].html`
...
| 11 | `tech-sharing`     | 8  | GitHub-dark, JetBrains Mono, terminal code blocks, agenda + Q&A | Tech-sharing sessions, internal tech talk, conference talk |
| 12 | `weekly-report`    | 7  | Corporate clarity, 8-cell KPI grid, shipped list, 8-week bar chart, next-week table | Weekly report, team status update, business review |
| 13 | `xhs-post`         | 9  | **3:4 @ 810×1080**, warm pastel, dashed sticker cards, page dots | Xiaohongshu (RED) image-and-text post, Instagram carousel |
...
| 15 | `presenter-mode-reveal` 🎤 | 6  | **Dedicated presenter mode** · tokyo-night default · 5 themes cycle via T key · each page ships a 150–300 word example script | **Tech talks / presentations / courses** — for scenarios where you press S to view the speaker script ✨ |
...
> 🎤 **For any presentation scenario (tech sharing / course / pitch), `presenter-mode-reveal` is recommended**, or follow the [presenter-mode.md](./presenter-mode.md) guide to add `<aside class="notes">` scripts to other templates.
