...
description: |
  ...
  "Nintendo-style", "sprite sheet animation", "pixel animation", or "retro-style animation".
triggers:
  - "sprite animation"
  - "pixel art animation"
  - "8-bit explainer"
...
4. **Top bar** — small mono row:
   - Left: title slug ("RANKING / EPISODE" or "EP. 01 / NINTENDO")
...
5. **Subject animations** — at least three independent looping animations
   ...
   - **Kinetic word**: 1–2 short display characters that fade-and-slide
     in sync with the bob (e.g. "HANA" — flower in Japanese).
