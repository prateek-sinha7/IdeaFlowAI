...
triggers:
  ...
  - "social media matrix data tracker"
  - "social media matrix dashboard template"
  - "social media data tracking template"
  - "new media data dashboard"
  - "new media matrix analytics"
  - "content operations data dashboard"
  - "short-video platform data dashboard"
  - "social commerce data dashboard"
od:
  mode: template
  platform: desktop
