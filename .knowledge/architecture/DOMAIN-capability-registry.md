...
- MOD-backend-app-api
watched_files: 13
code_signature: 0eb6cfa600a4
symbols_signature: de257f30a1f7
prose_signature: 0eb6cfa600a4
prose_symbols_signature: de257f30a1f7
...
### Imported by, from outside this domain (161)
...
- Importing a capability implementation module from [compiler.py](../../backend/agents/workflows/compiler.py), or anything
  ...
  [tests/agents/test_registry_capabilities.py](../../backend/tests/agents/test_registry_capabilities.py) in CI.
...
heavy-dependency app-side ones. [test_registry_capabilities.py](../../backend/tests/agents/test_registry_capabilities.py) asserts the
