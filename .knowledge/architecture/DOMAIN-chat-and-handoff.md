...
watched_files: 28
code_signature: 091d8bf5a3d2
symbols_signature: 5735815dda90
prose_signature: 091d8bf5a3d2
prose_symbols_signature: 5735815dda90
...
### Imported by, from outside this domain (29)
...
- **Put a model call, an `await`, or an I/O read inside
  ...
  [test_mechanical_router.py](../../backend/tests/unit/test_mechanical_router.py) and [test_rest_gate_commands.py](../../backend/tests/unit/test_rest_gate_commands.py) pin purity and
...
directly is caught by [tests/agents/test_banned_patterns.py](../../backend/tests/agents/test_banned_patterns.py).
...
[test_mechanical_router.py](../../backend/tests/unit/test_mechanical_router.py) and [test_rest_gate_commands.py](../../backend/tests/unit/test_rest_gate_commands.py) pin them.
...
([tests/agents/test_banned_patterns.py](../../backend/tests/agents/test_banned_patterns.py)) fails on any other site that builds a
