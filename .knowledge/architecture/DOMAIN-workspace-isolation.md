...
watched_files: 17
code_signature: 58efb4bba81e
symbols_signature: 47d39cf4a5d1
prose_signature: 58efb4bba81e
prose_symbols_signature: 47d39cf4a5d1
...
- *Weakening the containment check.* Replacing `is_relative_to` with a
  ...
  [tests/agents/test_isolation.py](../../backend/tests/agents/test_isolation.py) is the guard.
...
- *Switching `serialize_sandbox_deliverable` to `read_text`.* Universal-newline
  ...
  [tests/agents/test_sandbox_deliverable.py](../../backend/tests/agents/test_sandbox_deliverable.py) pins the format.
