...
watched_files: 16
code_signature: 4ddebc9de858
symbols_signature: a37c3fbe233c
prose_signature: 4ddebc9de858
prose_symbols_signature: a37c3fbe233c
...
### Imported by, from outside this domain (42)
...
### Imports, from outside this domain (34)
...
1. [app/layout.tsx](../../frontend/src/app/layout.tsx) mounts [RunConnectionProvider.tsx](../../frontend/src/providers/RunConnectionProvider.tsx) at the root, so it is the single
   owner of every attached stream in the tab; [DashboardLayout.tsx](../../frontend/src/components/layout/DashboardLayout.tsx) and [page.tsx](../../frontend/src/app/dashboard/page.tsx) reach
   it through `useRunConnection`.
2. The user submits a brief; [page.tsx](../../frontend/src/app/dashboard/page.tsx) calls `RunConnectionProvider.tsx::sendCommand`
...
5. [page.tsx](../../frontend/src/app/dashboard/page.tsx) calls `RunConnectionProvider.tsx::attachRun`, which renders a
...
- Frame-shape drift is caught by [tests/unit/test_sse_stream.py](../../backend/tests/unit/test_sse_stream.py), which binds the endpoint's
...
- A subscriber-queue leak is covered by [tests/unit/test_run_stream_pool_leak.py](../../backend/tests/unit/test_run_stream_pool_leak.py).
...
or `seq` at all: [ndjson_adapter.py::run_od_prototype_pipeline](../../backend/agents/execution_engine/ndjson_adapter.py) drives
...
importing the test-support module, and [tests/unit/test_sse_stream.py](../../backend/tests/unit/test_sse_stream.py) binds the two — so
