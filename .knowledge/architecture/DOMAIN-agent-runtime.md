...
watched_files: 17
code_signature: 122234dcad6d
symbols_signature: 30702a32574a
prose_signature: 122234dcad6d
prose_symbols_signature: 30702a32574a
...
### External
boto3, botocore, deepagents, langchain, langchain_anthropic, langchain_core
<!-- /AUTO-GENERATED -->
...
- **The id list.** [model_catalog.py](../../backend/agents/capabilities/model_catalog.py) is pure data — five `ModelEntry` records, each
...
in [backend/tests/agents/test_banned_patterns.py](../../backend/tests/agents/test_banned_patterns.py), which additionally asserts the allow-listed file
