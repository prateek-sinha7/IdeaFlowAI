...
Full text: `ctx.py --show <ID>`. Rules by area: `ctx.py --rules <area>`. Areas carrying history: `agents` (225), `workflow` (201), `frontend` (186), `sse` (153), `backend` (93), `artifacts` (90), `auth` (84), `resume` (54).
