...
Full text: `ctx.py --show <ID>`. Rules by area: `ctx.py --rules <area>`. Areas carrying history: `agents` (248), `workflow` (209), `frontend` (190), `sse` (173), `backend` (104), `auth` (101), `artifacts` (100), `resume` (66).
