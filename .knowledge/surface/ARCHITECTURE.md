...
| `frontend/src/app` | Next.js routes | 41 | 22 files |
...
Full text: `ctx.py --show <ID>`. Rules by area: `ctx.py --rules <area>`. Areas carrying history: `agents` (189), `workflow` (178), `frontend` (153), `sse` (128), `artifacts` (78), `auth` (73), `backend` (69), `resume` (41).
