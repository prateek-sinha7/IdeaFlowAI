---
built_from_commit: 9b0fb8c7912236bd331287daaa90fe316748bef6
built_at: 2026-08-17
cards_indexed: 597
modules_indexed: 36
---
...
- [MOD-backend-agents](architecture/MOD-backend-agents.md) — backend/agents — 123 files — `backend/agents` is the execution kernel. It compiles declarative `workflow.yaml`…
...
- [MOD-backend-app-agents](architecture/MOD-backend-app-agents.md) — backend/app/agents — 40 files — The `deepagents` runtime **adapter layer**: it turns a `create_deep_agent` LangGraph…
...
- [MOD-frontend-src-app](architecture/MOD-frontend-src-app.md) — frontend/src/app — 29 files — This is the Next.js App Router tree: it owns the root HTML shell, fonts, and global…
...
- [MOD-frontend-src-components-results](architecture/MOD-frontend-src-components-results.md) — frontend/src/components/results — 30 files — Implements the Results/Steps/Files/Audit surfaces mounted inside `PreviewPanel`: the…
...
- [MOD-frontend-src-lib](architecture/MOD-frontend-src-lib.md) — frontend/src/lib — 48 files — The frontend's non-UI core: everything that talks to the FastAPI backend, and every piece…
