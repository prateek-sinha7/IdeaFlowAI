---
built_from_commit: 424878bd070cf2d4022d5966a4070bb657a958bf
built_at: 2026-08-17
cards_indexed: 499
modules_indexed: 36
---
...
- [MOD-backend-app-core](architecture/MOD-backend-app-core.md) — backend/app/core — 7 files — Cross-cutting security and configuration primitives with no knowledge of any specific…
...
- [MOD-backend-scripts](architecture/MOD-backend-scripts.md) — backend/scripts — 6 files — Operator-run, one-off maintenance scripts — data migration, forensic audit, build-time…
- [MOD-frontend-src](architecture/MOD-frontend-src.md) — frontend/src — 32 files — not yet authored
- [MOD-frontend-src-app](architecture/MOD-frontend-src-app.md) — frontend/src/app — 25 files — This is the Next.js App Router tree: it owns the root HTML shell, fonts, and global…
...
- [MOD-frontend-src-components-history](architecture/MOD-frontend-src-components-history.md) — frontend/src/components/history — 11 files — Implements the run-history browser: the searchable/filterable list of past runs grouped…
...
- [MOD-frontend-src-components-savedworkflows](architecture/MOD-frontend-src-components-savedworkflows.md) — frontend/src/components/savedworkflows — 2 files — Renders "My Workflows" — the user's saved custom-agent-selection workflows, as a…
- [MOD-frontend-src-components-settings](architecture/MOD-frontend-src-components-settings.md) — frontend/src/components/settings — 3 files — Renders the Account Settings page — profile/password, AI model preference, usage & plan…
...
- [MOD-frontend-src-components-workflow](architecture/MOD-frontend-src-components-workflow.md) — frontend/src/components/workflow — 56 files — Renders every pre-run surface for composing and launching a deliverable — the unified…
...
- [MOD-frontend-src-lib](architecture/MOD-frontend-src-lib.md) — frontend/src/lib — 39 files — The frontend's non-UI core: everything that talks to the FastAPI backend, and every piece…
