---
built_from_commit: fd98e148e06da59743638c4bdfa5647b407101fc
built_at: 2026-08-17
cards_indexed: 499
modules_indexed: 36
---
...
- [MOD-backend-agents](architecture/MOD-backend-agents.md) — backend/agents — 121 files — `backend/agents` is the execution kernel. It compiles declarative `workflow.yaml`…
...
- [MOD-backend-alembic-versions](architecture/MOD-backend-alembic-versions.md) — backend/alembic/versions — 32 files — The Alembic revision chain for the backend's SQLAlchemy schema — a single linear history…
...
- [MOD-frontend-src-lib](architecture/MOD-frontend-src-lib.md) — frontend/src/lib — 42 files — The frontend's non-UI core: everything that talks to the FastAPI backend, and every piece…
