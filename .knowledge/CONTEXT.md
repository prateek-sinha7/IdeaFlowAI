---
built_from_commit: 602296cc8ee5348ccc9276c08d36fdcc38e53f8b
built_at: 2026-08-17
cards_indexed: 1065
modules_indexed: 36
---
...
- [MOD-backend-agents](architecture/MOD-backend-agents.md) — backend/agents — 124 files — `backend/agents` is the execution kernel. It compiles declarative `workflow.yaml`…
...
- [MOD-backend-alembic-versions](architecture/MOD-backend-alembic-versions.md) — backend/alembic/versions — 39 files — The Alembic revision chain for the backend's SQLAlchemy schema — a single linear history…
...
- [MOD-backend-app-agents](architecture/MOD-backend-app-agents.md) — backend/app/agents — 42 files — The `deepagents` runtime **adapter layer**: it turns a `create_deep_agent` LangGraph…
...
- [MOD-frontend-src](architecture/MOD-frontend-src.md) — frontend/src — 35 files — not yet authored
- [MOD-frontend-src-app](architecture/MOD-frontend-src-app.md) — frontend/src/app — 32 files — This is the Next.js App Router tree: it owns the root HTML shell, fonts, and global…
...
- [MOD-frontend-src-components-catalog](architecture/MOD-frontend-src-components-catalog.md) — frontend/src/components/catalog — 5 files — The Home landing screen: a data-driven grid of launchable workflow types plus a "Jump…
...
- [MOD-frontend-src-components-handoff](architecture/MOD-frontend-src-components-handoff.md) — frontend/src/components/handoff — 10 files — Renders the `/flowin-handoff` feature: a standalone page where an IDE-launched coding…
- [MOD-frontend-src-components-history](architecture/MOD-frontend-src-components-history.md) — frontend/src/components/history — 15 files — Implements the run-history browser: the searchable/filterable list of past runs grouped…
...
- [MOD-frontend-src-components-library](architecture/MOD-frontend-src-components-library.md) — frontend/src/components/library — 5 files — Renders the Library page — a single-file browsable/searchable catalog of the agents…
- [MOD-frontend-src-components-preview](architecture/MOD-frontend-src-components-preview.md) — frontend/src/components/preview — 28 files — Renders a run's deliverable in the Preview surface: `PreviewPanel` is the tab shell…
- [MOD-frontend-src-components-results](architecture/MOD-frontend-src-components-results.md) — frontend/src/components/results — 35 files — Implements the Results/Steps/Files/Audit surfaces mounted inside `PreviewPanel`: the…
- [MOD-frontend-src-components-savedworkflows](architecture/MOD-frontend-src-components-savedworkflows.md) — frontend/src/components/savedworkflows — 4 files — Renders "My Workflows" — the user's saved custom-agent-selection workflows, as a…
- [MOD-frontend-src-components-settings](architecture/MOD-frontend-src-components-settings.md) — frontend/src/components/settings — 6 files — Renders the Account Settings page — profile/password, AI model preference, usage & plan…
...
- [MOD-frontend-src-components-ui](architecture/MOD-frontend-src-components-ui.md) — frontend/src/components/ui — 13 files — Project-owned, token-driven visual primitives (`Button`, `Badge`, `Card`, `Pill`, `Tabs`…
- [MOD-frontend-src-components-workflow](architecture/MOD-frontend-src-components-workflow.md) — frontend/src/components/workflow — 68 files — Renders every pre-run surface for composing and launching a deliverable — the unified…
...
- [MOD-frontend-src-hooks](architecture/MOD-frontend-src-hooks.md) — frontend/src/hooks — 35 files — React hooks layer split into two concerns: **live-run/SSE state** (transport, replay…
- [MOD-frontend-src-lib](architecture/MOD-frontend-src-lib.md) — frontend/src/lib — 53 files — The frontend's non-UI core: everything that talks to the FastAPI backend, and every piece…
