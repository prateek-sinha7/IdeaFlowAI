...
36 logical modules over 713 tracked source files. Each entry links to its
...
| [MOD-backend-alembic-versions](architecture/MOD-backend-alembic-versions.md) | `backend/alembic/versions` | 39 |
