...
summary: >-
  Prototype Thinking tab hides full prompts, context sources, and agent-handoff
  artifacts — AgentThinkingTab routes prototype runs to PrototypePipelineView
  (Phase-card layout) which never renders InputPromptSection, ContextSourcesRow
source: .planning/FIX-REGISTER.md#fix-022
ticket: KAN-80
