...
summary: >-
  Notification panel shows "0" text and wrong progress for running pipelines — React
  renders the number 0 as visible text "0" when n.agentsTotal && ... short-circuits to
  0 (falsy number) in JSX
