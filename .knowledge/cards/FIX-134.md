...
date: 2026-07-28
status: done
area: [frontend, sse, workflow, agents]
files:
  - frontend/src/app/dashboard/page.tsx
summary: >-
  Concurrent pipeline "nothing in Steps" — second run's pipeline_start reset the
  shared reducer, wiping first run's agent list
source: .planning/FIX-REGISTER.md#fix-134
ticket: KAN-125
