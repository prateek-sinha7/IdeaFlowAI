...
summary: >-
  Output filename inconsistent between Preview URL bar / Download and Files tab across
  all workflow types; mid-word truncation bug
source: .planning/FIX-REGISTER.md#fix-140
ticket: KAN-128
