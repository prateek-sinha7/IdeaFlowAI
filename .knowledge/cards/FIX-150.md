...
summary: >-
  PPT revision → User Stories chain fires run but Steps trace stays empty; no agents
  start — handleChainPipeline parsed workflowInput (the revision blob) to get
  chainBrief
source: .planning/FIX-REGISTER.md#fix-150
ticket: KAN-137
