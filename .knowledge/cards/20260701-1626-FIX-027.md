...
type: fix
kind: event
title: File attachment content rendered in textarea — separate content from display
status: done
applies_to:
  phases:
  - '21'
...
verification:
  ...
  status: passed
  test_files: []
compact_summary: 'Prototype wizard hard-required a template and the style clarifier asked a presentation-tone question inappropriate without one; made templates optional and added a UI-type question (KAN-87).'
