...
type: fix
kind: event
title: ext Received panel shows "artifact" instead of source labels — formatContextSource
...
verification:
  ...
  status: passed
  test_files: []
compact_summary: '`formatContextSource` didn''t handle the new `run_input`/`context_block` types so they all displayed as "artifact"; also fixed filename dispatch to use the correct viewed-run type.'
...
**Depends on:** [FIX-141](20260729-FIX-141.md), [FIX-142](20260729-FIX-142.md), [FIX-143](20260729-FIX-143.md), [FIX-144](20260730-1252-FIX-144.md)
...
- **Phase(s) involved:** Phase 31 (REQ-CHATUI-01 RunChatLane), Phase 39 (REQ-RUNUI-06 DeliverableCard), follow-up to FIX-141
- **Deleted code verified (not resurrected):** No deleted code touched.
