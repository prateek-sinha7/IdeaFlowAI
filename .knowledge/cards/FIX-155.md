...
summary: >-
  Header shows duplicate running workflow entries (7 instead of 3) — notifications for
  prototype/ppt not created when user_stories runs concurrently
source: .planning/FIX-REGISTER.md#fix-155
