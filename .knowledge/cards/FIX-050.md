...
summary: >-
  Add AI Coach Hub prototype template SKILL.md so the template appears in the gallery
  — skills/opendesign/design-templates/ai-coach-hub/SKILL.md was absent;
  od_loader._load_one_template() returns None when SKILL.md is missing
