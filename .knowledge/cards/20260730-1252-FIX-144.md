...
type: fix
kind: event
title: GET /api/runs?limit=100 returns 2.85MB uncompressed, takes 5.4–6.8s — slim
  list schema + column-projected query + X-Total-Count + Load More pagination
status: done
applies_to:
  phases:
  - '04'
  ...
  - '25'
  modules:
  - 0030_workflow_runs_user_created_index
  - HomeLaunchGrid
...
verification:
  ...
  status: passed
  test_files: []
compact_summary: '`GET /api/runs?limit=100` returned every heavy Text column, producing a 2.85MB/5-7s response; added a slim list schema, column-projected query, index, and pagination.'
...
**Depends on:** [FIX-051](20260716-1058-FIX-051.md), [FIX-158](20260807-1348-FIX-158.md)

**Referenced by:** [FIX-144b](20260730-FIX-144b.md), [ISS-198](20260828-1400-ISS-198.md)
