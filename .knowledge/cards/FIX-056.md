...
date: 2026-07-16
status: done
area: [frontend, backend, workflow, agents]
files:
  - frontend/src/components/workflow/IdeaInputPage.tsx
  - backend/agents/workflows/custom/workflow.yaml
summary: >-
  Custom workflow — fix empty agent seed, add 8 default agents, fix add/remove limits,
  update blank-slate copy
source: .planning/FIX-REGISTER.md#fix-056
ticket: KAN-112
