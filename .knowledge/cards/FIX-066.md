...
summary: >-
  Restyle AgentPromptSection to dark card with readable white sans-serif text —
  Container used light white card (border-gray-200 bg-white) and prompt body used tiny
  monospace font (font-mono text-[10.5px] text-gray-600)
source: .planning/FIX-REGISTER.md#fix-066
