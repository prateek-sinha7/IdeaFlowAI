...
type: fix
kind: event
title: '"Revision started" and "Delivered" still showing twice after FIX-175 — FIX-172''s
  appendRunChatFrames fetched ALL events from seq 0 — including already-delive...'
status: done
applies_to:
  phases:
  - '31'
...
verification:
  ...
  status: passed
  test_files: []
compact_summary: 'appendRunChatFrames fetched all events from seq 0 instead of afterSeq=lastSeqRef, re-adding already-delivered ''Revision started''/''Delivered'' cards as duplicates.'
...
**Depends on:** [FIX-172](20260805-1853-FIX-172.md), [FIX-173](20260805-1853-FIX-173.md), [FIX-175](20260805-1853-FIX-175.md)
...
**Phase / trigger:** Phase 31 (REQ-CHATUI-01), FIX-172
...
#### Phase Context
- **Phase(s) involved:** Phase 31 (REQ-CHATUI-01), FIX-172, FIX-173
