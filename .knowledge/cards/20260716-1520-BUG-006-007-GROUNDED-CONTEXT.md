---
id: BUG-006-007-GROUNDED-CONTEXT
type: bug
kind: event
title: BUG-006 + BUG-007 — grounded fix spec
status: resolved
severity: minor
applies_to:
  phases: []
...
verification:
  ...
  status: required
  test_files: []
compact_summary: 'BUG-006: lane type chip read workflowType not effectiveReviseType, missing a third stale-label consumer; BUG-007: StrictMode double-invokes the launch effect, minting two dev-only runs per launch.'
