...
type: fix
kind: event
title: Extend user_stories clarification to capture full intent for short prompts
...
verification:
  ...
  status: passed
  test_files: []
compact_summary: 'Short prompts triggered only 4 generic clarify questions, missing personas/journeys/business-rules/compliance; extended clarify.defaults, DOMAIN_KB, and QUESTION_LIBRARY to 8 dimensions.'
...
**Referenced by:** [FIX-003b](20260616-FIX-003b.md), [FIX-005](20260616-FIX-005.md)
...
#### Phase Context
- **Phase(s) involved:** Phase 4 (REQ-MAN-04 — clarify.defaults in manifest) + Phase 8 (ClarifyEngine question library)
