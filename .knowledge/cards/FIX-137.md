...
date: 2026-07-29
status: done
area: [frontend, sse, workflow, auth]
files:
  - frontend/src/app/dashboard/page.tsx
  - frontend/src/providers/RunConnectionProvider.tsx
summary: >-
  Multi-tab isolation + same-tab isForeignFrame empty-set gap — new tabs show running
  workflows, concurrent same-tab runs not fully isolated
source: .planning/FIX-REGISTER.md#fix-137
