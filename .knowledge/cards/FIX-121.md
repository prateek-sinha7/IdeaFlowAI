...
summary: >-
  3 resume/stop bugs: (1) Spec Kit Analyzer skipped on resume — agent stopped mid-run
  classified complete; (2) stop unresponsive appearance from reconnecting banner; (3)
  yellow Reconnecting banner on every Stop click
source: .planning/FIX-REGISTER.md#fix-121
invariants: [INV-1, INV-3, INV-12, SC-001]
area: [sse, frontend, resume]
relates: [FIX-122]
---

# FIX-121

**Phase / trigger:** Phase 50/44/29 (RESUME-18/KAN-120/BUG-015)
