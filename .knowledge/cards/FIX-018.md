...
date: 2026-06-23
status: done
area: [backend, agents, runtime]
files:
  - backend/agents/execution_engine/engine.py
  - backend/app/api/websocket.py
summary: >-
  hook_run WS events never reach the frontend Audit tab — ectx.event_queue never set +
  after_step never fired
source: .planning/FIX-REGISTER.md#fix-018
ticket: KAN-73
