...
summary: >-
  Running dropdown and notification panel: click doesn't open correct run page;
  progress shows 0/N; onViewResults status filter misses planning/generating
source: .planning/FIX-REGISTER.md#fix-157
...
**Phase / trigger:** Phase 35 (SHELL-01 AppHeader), FIX-156 follow-up
