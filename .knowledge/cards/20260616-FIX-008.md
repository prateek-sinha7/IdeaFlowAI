...
type: fix
kind: event
title: Spec Writer asks clarifying questions instead of producing spec — entire pipeline
...
verification:
  ...
  test_files:
  - backend/agents/prompts/prototype-specify/AGENT.md
compact_summary: 'prototype-specify asked a clarifying question instead of emitting a <spec> on ambiguous briefs, cascading into an empty plan and build; fixed with a never-ask-questions output contract.'
...
**Referenced by:** [FIX-009](20260616-FIX-009.md)
