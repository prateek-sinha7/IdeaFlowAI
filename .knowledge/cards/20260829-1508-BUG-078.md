...
**Depends on:** [ISS-293](20260828-1924-ISS-293.md), [ISS-402](20260828-2121-ISS-402.md)
...
- **Fix cards:** [FIX-364](20260829-0041-FIX-364.md) (ISS-293 — one `CONSTITUTION_MAX_CHARS = 4000` behind the counter, the textarea's `maxLength` and the Save-disable check; backend's 1,048,576 cap untouched). ISS-402 is a separate card, still open.
