...
type: fix
kind: event
title: OD gallery thumbnails generated at BUILD time (backend Docker image) + served
  via backend endpoint; missing ⇒ live iframe fallback
status: done
applies_to:
  phases:
  - '04'
...
verification:
  ...
  status: passed
  test_files:
  - tests/unit/test_template_assets.py
compact_summary: 'Committing ~106 screenshot binaries was undesirable; thumbnails now generate during the backend Docker build via a Playwright script and are served by a new endpoint.'
...
**Depends on:** [FIX-039](20260707-0125-FIX-039.md), [FIX-050](20260715-1145-FIX-050.md)

**Referenced by:** [FIX-040b](20260706-FIX-040b.md), [FIX-041b](20260708-FIX-041b.md)
