...
summary: >-
  Concurrent run review gates cross-contaminate screens and appear before agent output
  (corrected: trackedRunIdRef not activelyBuildingRunIdRef)
source: .planning/FIX-REGISTER.md#fix-153
ticket: KAN-146
