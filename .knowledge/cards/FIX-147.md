...
summary: >-
  clicking Presentation in multi-run dropdown navigated to User Stories run — All
  dropdown entries called the same onGoToPipeline callback (routes to the single
  active run)
source: .planning/FIX-REGISTER.md#fix-147
ticket: KAN-132
