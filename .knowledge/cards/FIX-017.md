...
summary: >-
  PPT composer produces 697-char confused validator output (validator: "I don't see an
  HTML artifact") — _compose_injection() in factory.py hardcoded a prototype-specific
  CRITICAL OUTPUT RULES block (section 0) that fires for ANY agent
source: .planning/FIX-REGISTER.md#fix-017
