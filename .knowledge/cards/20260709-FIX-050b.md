...
type: fix
kind: event
title: Prototype revision agent AGENT.md restructured for task planning, mandatory
  design.md read, and incremental execution — AGENT.md "How to work" jumped directl...
status: done
applies_to:
  phases:
  - '14'
...
verification:
  ...
  status: passed
  test_files: []
compact_summary: 'AGENT.md let the revision agent skip planning/design.md context, causing invented CSS off-design; restructured into a mandatory read-plan-execute-verify flow.'
...
**Depends on:** [FIX-050](20260715-1145-FIX-050.md), [FIX-053](20260713-FIX-053.md)
