...
summary: >-
  Chained pipeline uses wrong source run context — recentRuns type-scan returns older
  completed run instead of the one on screen
source: .planning/FIX-REGISTER.md#fix-139
