...
| 12 | frontend·workflow | 22 | DONE | ISS-399,ISS-491,ISS-420,ISS-421,ISS-480,ISS-603,ISS-423,ISS-384,ISS-429,BUG-048 (FIX-476–479); ISS-228/284/361/364/365/366/368 already-fixed | 0 | ISS-197(bfcache design),ISS-189(DS picker design),ISS-377(schema decision),ISS-362(gate sync design) | [20260902-1400-domain-12-frontend-workflow.md](reports/20260902-1400-domain-12-frontend-workflow.md) |
| 13 | frontend·layout | 23 | DONE | ISS-252,ISS-622,ISS-143 (FIX-480–482); BUG-006-007/008-011/012/012-FL/014/019-020/DEF-44-12-4,ISS-283 already-fixed | 0 | ISS-472/473/474 (tier gate: canRunPipeline import + page.tsx + /workflow/create/page.tsx, design decision) | [20260902-1530-domain-13-frontend-layout.md](reports/20260902-1530-domain-13-frontend-layout.md) |
| 14 | backend·api | 29 | DONE (29/29 resolved: CLOSED 9, ALREADY_FIXED 5, ESCALATED 15) | 4+previously | 0 | 15 | [20260902-1600-domain-14-backend-api.md](reports/20260902-1600-domain-14-backend-api.md) |
...
- Run 2026-09-02T18:00:00Z: **Domain 15 (backend·other) KiroCrew verification DONE** — all 535 domain-15 witness tests green (533 collected + 2 from KiroCrew fixes). Two Windows-only regressions fixed during this session: (a) `skill_staging.py` `write_text` missing `encoding="utf-8"` (Fix A); (b) stale `xfail(strict=True)` for ISS-257 in `test_register_password_echo.py` (Fix B). Dedup regenerated: 106 open work units remain. KiroCrew report at `reports/20260902-1800-domain-15-backend-other.md`.

- Run 2026-09-02T16:00:00Z: **Domain 14 (backend·api) DONE** — 4 FIXED (ISS-418 → FIX-483; ISS-435/436/437 → FIX-484), 2 ALREADY_FIXED (BUG-016 _STREAM_TERMINAL_TYPES already correct; ISS-137 FIX-245 intentional dead-code decision), 9 ESCALATED (ISS-161 re-test note; ISS-398 entitlements cross-domain; ISS-422 frontend fix site; ISS-180/181/263/381 design decisions pending; BUG-015 frontend reconnect; ISS-105 uvicorn out-of-scope). pytest 109/109 green (test_restart_resume + test_rest_answers_cancel + test_run_shutdown). Dedup regenerated: 108 → 106 units. See `reports/20260902-1600-domain-14-backend-api.md`.

- Run 2026-09-02T15:30:00Z: **Domain 13 (frontend·layout) DONE** — 3 FIXED (ISS-252/622/143 → FIX-480–482), 17 ALREADY_FIXED (BUG-006-007/008-011/012/012-FL/014/019-020/DEF-44-12-4 confirmed by prior domain work; ISS-283/347/373 confirmed via FIX-338/331/352; ISS-136/346/348/349 deferred/out-of-scope), 3 ESCALATED (ISS-472/473/474 tier gate: canRunPipeline import absent in page.tsx, covers 2 files + design decision). tsc clean (0 source errors), vitest 67/67 green (laneTitle/launchLatch/contentSourceRunType/contentSourceRunScope/revisionFamilyLinkage/freshLaunchTranscript/LaneRunHeader/LaunchWizard suites). Dedup regenerated: 121 → 108 units. See `reports/20260902-1530-domain-13-frontend-layout.md`.

- Run 2026-09-02T14:00:00Z: **Domain 12 (frontend·workflow) DONE** — 10 FIXED (ISS-399/491 → FIX-476; ISS-420/421 → FIX-477; ISS-480 → FIX-478; ISS-603/423/384/429/BUG-048 → FIX-479), 7 ALREADY_FIXED (ISS-228/284/361/364/365/366/368 confirmed by FIX-338/346/348/349), 4 ESCALATED (ISS-197 bfcache design; ISS-189 DS picker design; ISS-377 schema decision; ISS-362 gate sync design). tsc clean (0 source errors), vitest 50+/50+ green (LaunchWizard/AgentsPopup/AgentLibrary/ReviewGatesSection/IdeaInputPage suites). Dedup regenerated: 131 → 121 units. See `reports/20260902-1400-domain-12-frontend-workflow.md`.
