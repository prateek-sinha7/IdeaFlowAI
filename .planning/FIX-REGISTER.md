...
| FIX-158 | 2026-08-07 | Part of the QA-guardrails / knowledge-cards / auth-atomicity batch. **Exact FIX-158 scope is NOT recoverable.** | Not recorded. | not recoverable | commit `8f8d5efe` | not recorded | **BACKFILLED 2026-08-12 by ISS-069 — evidence: commit `8f8d5efe` + FIX-REGISTER prose.** Note `d9402442` ("deduplicate FIX-REGISTER.md (FIX-158..FIX-182 by ID)") shows this range was already known to be drift-prone. |
| FIX-159 | 2026-08-02 | EC2 host-config heredocs live in `reconcile-host-config.sh`, NOT `bootstrap-ec2.sh` — corrected, and pinned by a test. | The deploy heredocs had been assumed to live in the bootstrap script; editing there had no effect. | `backend/tests/unit/test_nginx_site_template.py:8` | commit `db668778` (KAN-134 SSE heartbeat batch) | not recorded | **BACKFILLED 2026-08-12 by ISS-069 — evidence: commit `db668778` + an explicit in-test citation.** The test docstring names the fix, which is how the scope was recovered. |
| FIX-162 | 2026-08-07 | Part of the QA-guardrails / knowledge-cards / auth-atomicity batch. **Exact FIX-162 scope is NOT recoverable.** | Not recorded. | not recoverable | commit `8f8d5efe` | not recorded | **BACKFILLED 2026-08-12 by ISS-069 — evidence: commit `8f8d5efe` body only.** Scope unrecoverable and deliberately not invented. |
