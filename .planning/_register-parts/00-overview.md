...
> **Per-phase detail:** the 21 sections that follow (Phase 1…21), each summarizing one `.planning/phases/<NN-…>/` folder and pointing to the exact file + heading for any detail.
...
- **Milestone v1.0: COMPLETE on plans — 21/21 phases, 104/104 plans, 117/117 requirements** (`STATE.md` 100%). Phases 1–12 were the planned milestone (**71 plans**, all 117 v1 requirements mapped 1:1, coverage 117/117); Phase 13 added 6 + Phase 14 added 4 + Phase 15 added 3 + Phases 16–17 added 7 + Phases 18–19 added 8 + Phases 20–21 added 5 post-milestone plans. Verified offline; the full milestone-end live-Bedrock re-pass ran **2026-06-12** (`.planning/live-verification/REPORT-2026-06-12.md`; an earlier 2026-06-11 pass covered Phase 12); a 2026-06-13 deep root-cause investigation (clusters A–E) drove Phases 16–19; **Phases 20–21 (2026-06-14) realized the formerly-v2 WF-DB-01** (DB-backed user-authored workflows). Status is `verifying`. → `ROADMAP.md` (Progress table), `STATE.md` (footer).
...
### 6. The 21 Phases (strangler order, strictly sequential)
...
The 21 sections that follow summarize each folder and point to the exact file + heading for any detail.
