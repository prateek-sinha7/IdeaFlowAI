...
Offline: `tests/agents` **238 passed / 17 skipped / 0 failed**, ruff clean. **Live Bedrock runs are next**
(flip `RUN_LIVE_BEDROCK=1`, default profile); the live smoke is being run/debugged separately.
