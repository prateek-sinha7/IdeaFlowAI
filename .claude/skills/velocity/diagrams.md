...
```
python3 tools/knowledge/build_architecture.py --affected $(git diff --name-only HEAD~1)
```
...
```
python3 tools/knowledge/build_architecture.py --stamp .knowledge/architecture/DOMAIN-<name>.md
```
...
```
python3 tools/knowledge/build_architecture.py --stale-prose   # expect 0 stale
python3 tools/knowledge/validate_links.py                     # expect 0 broken
```
