...
**203 open cards → 199 units of work** (46 families + 153 singletons), schedulable as **40 work batches** — see [Work batches](#work-batches--how-to-actually-run-this) for the execution view. **203 closed** — see [Closed](#-closed--fix-landed).
...
|---|---|---|---|
| A′ | root **already fixed**, siblings still open — replicate the landed diff | 28 | 42 |
| A | declared family, root and siblings both open — one line trip | 3 | 7 |
| B | same file **and** same defect class — proposed, needs review | 15 | 22 |
| C | no kin found — stays its own row | — | 143 |

---

## ✅ Closed — fix landed

203 defect card(s) now `status: resolved`. Kept here so this one file
...
|---|---|---|---|
| [ISS-470](../.knowledge/cards/20260828-2310-ISS-470.md) | [FIX-441](../.knowledge/cards/20260831-2001-FIX-441.md) | — | Same commit-then-refresh(row) shape as ISS-319: a concurrent PUT could report the OTHER PATs github_username/scopes as its own |
| [ISS-471](../.knowledge/cards/20260828-2310-ISS-471.md) | [FIX-441](../.knowledge/cards/20260831-2001-FIX-441.md) | — | Same race as ISS-319: _to_response(user, db) reads user.tier/is_admin post-refresh, so a concurrent admin write can be reported as this call's own |
| [ISS-144](../.knowledge/cards/20260813-0205-ISS-144.md) | [FIX-247](../.knowledge/cards/20260813-0205-FIX-247.md) | — | POST /answers has no terminal-run 409 guard unlike /gate, though the needed helper is already imported — a cancelled run silently 200s and drops the answer. |
| [BUG-004-GROUNDED-CONTEXT](../.knowledge/cards/20260716-1231-BUG-004-GROUNDED-CONTEXT.md) | [FIX-440](../.knowledge/cards/20260831-2002-FIX-440.md) | — | FastAPI tears down Depends(get_db) before the SSE generator body runs, so read_events opens a fresh pooled connection per stream that ScopedStore never closes, leaking one per live stream. |
| [BUG-017-GROUNDED-CONTEXT](../.knowledge/cards/20260717-1336-BUG-017-GROUNDED-CONTEXT.md) | — (closed by its own grounded-fix-spec) | — | page.tsx voided the sendCommand promise so the re-fetch raced ahead of the persisted chat_reply; awaiting it fixed delivery. |
| [ISS-098](../.knowledge/cards/20260812-1153-ISS-098.md) | [FIX-425](../.knowledge/cards/20260831-1804-FIX-425.md) | — | wave_scheduler catches except Exception to flip a wave row terminal, but CancelledError inherits BaseException so a cancelled wave stays stuck at running. |
| [ISS-101](../.knowledge/cards/20260812-1232-ISS-101.md) | [FIX-426](../.knowledge/cards/20260831-1806-FIX-426.md) | — | conversation.py calls unbounded read_events then filters in Python to build a 6-turn transcript, now unconditional on every Concierge turn. |
| [ISS-106](../.knowledge/cards/20260812-1315-ISS-106.md) | [FIX-428](../.knowledge/cards/20260831-1816-FIX-428.md) | — | close_checkpointer()'s pool.close() has no timeout, so a slow Postgres pool close can push teardown past the SIGKILL deadline undetected. |
| [ISS-118](../.knowledge/cards/20260812-1612-ISS-118.md) | [FIX-429](../.knowledge/cards/20260831-1818-FIX-429.md) | — | Eight offline tests construct a real LLM provider client (five bypassing build_model) but never invoke it, so they're exempted by nodeid. |
| [ISS-120](../.knowledge/cards/20260812-1637-ISS-120.md) | [FIX-427](../.knowledge/cards/20260831-1813-FIX-427.md) | — | Bedrock prompt caching is one global switch with no per-workflow override; short runs that write cache never re-read pay a pure 25% surcharge. |
| [ISS-185](../.knowledge/cards/20260825-2115-ISS-185.md) | [FIX-431](../.knowledge/cards/20260831-1829-FIX-431.md) | — | The composer hunts for template files at the skill mount point while the real files sit at /references/, burning turns; its own preamble said "the filesystem paths in the SKILL.md don't exist". |
| [ISS-357](../.knowledge/cards/20260828-1915-ISS-357.md) | [FIX-430](../.knowledge/cards/20260831-1827-FIX-430.md) | — | The fixture builds its own FastAPI() and includes only auth_router, so app.main's RequestValidationError handler never applies; the assertion is correct but the app under test is not the application. |
| [ISS-631](../.knowledge/cards/20260831-0115-ISS-631.md) | [FIX-433](../.knowledge/cards/20260831-1859-FIX-433.md) | — | roster and compiled sequence diverge from the manifest for all three revision pipelines; 15 tests witness what looks like one root cause |
| [ISS-633](../.knowledge/cards/20260831-0115-ISS-633.md) | [FIX-432](../.knowledge/cards/20260831-1842-FIX-432.md) | — | four tests expect exactly one exact-kind revision ref and get another count; two FE-contract tests surface list index out of range in the payload |
| [ISS-635](../.knowledge/cards/20260831-0115-ISS-635.md) | [FIX-435](../.knowledge/cards/20260831-1909-FIX-435.md) | — | the spec-018 manifest declares planner: skip where parity requires run, and its clarify.defaults is empty where the engine dict is not |
| [ISS-636](../.knowledge/cards/20260831-0115-ISS-636.md) | [FIX-436](../.knowledge/cards/20260831-1919-FIX-436.md) | — | the agents API and the frontend-consistency check assert gate values FIX-323 deleted from AGENT.md and workflow.yaml; same cause as ISS-617 |
| [ISS-637](../.knowledge/cards/20260831-0115-ISS-637.md) | [FIX-434](../.knowledge/cards/20260831-1907-FIX-434.md) | — | test_upgrade_then_check_reports_no_drift raises AutogenerateDiffsDetected: the ORM metadata and the migration chain have diverged |
| [ISS-072](../.knowledge/cards/20260812-0131-ISS-072.md) | [FIX-420](../.knowledge/cards/20260831-1630-FIX-420.md) | — | One 'Update the Specs' click still costs four approvals because the redundant in-pass analyze gate firing was identified but never suppressed. |
| [ISS-090](../.knowledge/cards/20260812-0632-ISS-090.md) | [FIX-422](../.knowledge/cards/20260831-1644-FIX-422.md) | — | Unlike update_specs_eligible, redoable=True is a hardcoded literal at all three gate sites, so any gated agent gets a Redo button with no eligibility rule. |
| [ISS-125](../.knowledge/cards/20260812-1852-ISS-125.md) | [FIX-421](../.knowledge/cards/20260831-1641-FIX-421.md) | — | _stamp_resume_marker reads the entire durable log just to compute the next seq and uses a non-retrying append, carrying the same lost-write exposure. |
| [ISS-131](../.knowledge/cards/20260812-2116-ISS-131.md) | [FIX-424](../.knowledge/cards/20260831-1652-FIX-424.md) | — | After FIX-242, a fan-out step that both declares a human gate and has its agent ticked silently gets no gate at all, via a stale dedupe prediction. |
| [ISS-402](../.knowledge/cards/20260828-2121-ISS-402.md) | [FIX-423](../.knowledge/cards/20260831-1650-FIX-423.md) | — | _inject_constitution (factory.py:673-699), called from _compose_system_prompt:586 every run, injects the full saved value with no length or token guard anywhere in the path |
| [ISS-182](../.knowledge/cards/20260825-2115-ISS-182.md) | [FIX-438](../.knowledge/cards/20260831-1954-FIX-438.md) | — | The UI no longer offers the blank template, but rows already storing custom-agent:<id> are untouched and keep failing at ingress with no repair path or warning. |
...
| [ISS-175](../.knowledge/cards/20260825-1115-ISS-175.md) | [FIX-297](../.knowledge/cards/20260825-1115-FIX-297.md) | — | Fixed — chain edges now added only where hasChainEdge holds instead of between every array neighbou… |
...
| [ISS-214](../.knowledge/cards/20260828-1633-ISS-214.md) | [FIX-327](../.knowledge/cards/20260828-1845-FIX-327.md) | — | WorkflowHistory.tsx:542 isPpt omits ppt_v2 (no renderType-style normalization), so its own Files ta… |
| [ISS-215](../.knowledge/cards/20260828-1633-ISS-215.md) | [FIX-327](../.knowledge/cards/20260828-1845-FIX-327.md) | — | FilesTab.tsx:436-440 feeds parentRun.type (raw, unnormalized) into deriveDeliverableFiles, so a ppt… |
...
| [ISS-230](../.knowledge/cards/20260828-1805-ISS-230.md) | [FIX-328](../.knowledge/cards/20260828-2014-FIX-328.md), [FIX-334](../.knowledge/cards/20260828-2149-FIX-334.md), [FIX-355](../.knowledge/cards/20260828-2358-FIX-355.md), [FIX-411](../.knowledge/cards/20260829-1646-FIX-411.md), [FIX-417](../.knowledge/cards/20260831-0110-FIX-417.md), [FIX-426](../.knowledge/cards/20260901-FIX-426.md) | — | handlePreviewPanelTabSelect (DashboardLayout.tsx:471-498) builds routeMap from contentSourceRunId o… |
...
| [ISS-232](../.knowledge/cards/20260828-1627-ISS-232.md) | [FIX-340](../.knowledge/cards/20260828-2230-FIX-340.md) | — | LibraryPage's cold-mount seed effect never fires setSelectedSkill for any id; only GET /api/skills/… |
...
| [ISS-244](../.knowledge/cards/20260828-1634-ISS-244.md) | [FIX-341](../.knowledge/cards/20260828-2236-FIX-341.md), [FIX-398](../.knowledge/cards/20260829-0352-FIX-398.md) | — | AccountSettings onChange handlers (L295, L306) never call setMessage(null), so the mismatch banner … |
| [ISS-245](../.knowledge/cards/20260828-1631-ISS-245.md) | [FIX-345](../.knowledge/cards/20260828-2250-FIX-345.md) | — | Login button disabled={isLoading} relies on a React state commit that has not landed by the time sy… |
...
| [ISS-257](../.knowledge/cards/20260828-1817-ISS-257.md) | [FIX-332](../.knowledge/cards/20260828-1915-FIX-332.md) | [ISS-224](../.knowledge/cards/20260828-1735-ISS-224.md) | RegisterRequest.password (min_length=8, schemas.py:16) has no custom 422 handler either (main.py re… |
...
| [ISS-274](../.knowledge/cards/20260828-1854-ISS-274.md) | [FIX-350](../.knowledge/cards/20260828-2340-FIX-350.md) | — | AgentRow.tsx reuses AdvancedExpander (Model/Validator/Gate/Retry only) not CanvasConfigRail, so Sim… |
...
| [ISS-277](../.knowledge/cards/20260828-1659-ISS-277.md) | [FIX-358](../.knowledge/cards/20260829-0011-FIX-358.md), [FIX-359](../.knowledge/cards/20260829-0014-FIX-359.md) | — | reopenTabFor/requestOpenTab thread only the tab name from parseViewPath, dropping ParsedView.agentI… |
...
| [ISS-292](../.knowledge/cards/20260828-1918-ISS-292.md) | [FIX-361](../.knowledge/cards/20260829-0029-FIX-361.md), [FIX-382](../.knowledge/cards/20260829-0223-FIX-382.md) | — | GET/PUT /api/settings/preferences apply no tier filter to available_models or preferred_model; Acco… |
| [ISS-293](../.knowledge/cards/20260828-1924-ISS-293.md) | [FIX-364](../.knowledge/cards/20260829-0041-FIX-364.md) | — | ConstitutionRequest.content max_length=1_048_576 (settings.py:355), textarea has no maxLength; 4000… |
...
| [ISS-302](../.knowledge/cards/20260828-1734-ISS-302.md) | [FIX-372](../.knowledge/cards/20260829-0141-FIX-372.md) | — | Delete dialog on /workflows only tracks deleteConfirmId, never the row name, so heading/body text i… |
...
| [ISS-311](../.knowledge/cards/20260828-1740-ISS-311.md) | [FIX-376](../.knowledge/cards/20260829-0152-FIX-376.md) | — | AgentLibrary excludes existingAgentIds from filteredAgents; the default user_stories workflow alrea… |
| [ISS-312](../.knowledge/cards/20260828-1941-ISS-312.md) | [FIX-374](../.knowledge/cards/20260829-0146-FIX-374.md) | — | handleFiles() isTextFile branch does content.slice(0, ATTACH_MAX_CHARS) with no truncation note, un… |
| [ISS-313](../.knowledge/cards/20260828-1946-ISS-313.md) | [FIX-318](../.knowledge/cards/20260827-0055-FIX-318.md), [FIX-380](../.knowledge/cards/20260829-0212-FIX-380.md) | — | PreviewPanel toolbar Download stays disabled forever when WorkflowRun.deliverable_filename is null … |
| [ISS-314](../.knowledge/cards/20260828-1946-ISS-314.md) | [FIX-378](../.knowledge/cards/20260829-0207-FIX-378.md) | — | PreviewPanel L1450 toolbar wrapper is flex items-center gap-1.5 flex-shrink-0 with no wrap/overflow… |
| [ISS-315](../.knowledge/cards/20260828-1750-ISS-315.md) | [FIX-375](../.knowledge/cards/20260829-0151-FIX-375.md) | — | ComposerPage.tsx:1075-1082 blocks Save workflow on an empty name by only focusing the input and set… |
| [ISS-316](../.knowledge/cards/20260828-1952-ISS-316.md) | [FIX-105](../.knowledge/cards/20260723-FIX-105.md), [FIX-229](../.knowledge/cards/20260812-0653-FIX-229.md), [FIX-381](../.knowledge/cards/20260829-0220-FIX-381.md) | — | resume_supersedes only checks pipeline_complete seq > cancelled seq, so a resumed run that instead … |
...
| [ISS-319](../.knowledge/cards/20260828-1804-ISS-319.md) | [FIX-361](../.knowledge/cards/20260829-0029-FIX-361.md), [FIX-382](../.knowledge/cards/20260829-0223-FIX-382.md) | — | update_preferences commits then db.refresh(user), so a concurrent commit lands between them and the… |
| [ISS-320](../.knowledge/cards/20260828-1802-ISS-320.md) | [FIX-385](../.knowledge/cards/20260829-0241-FIX-385.md), [FIX-386](../.knowledge/cards/20260831-1020-FIX-386.md), [FIX-423](../.knowledge/cards/20260901-FIX-423.md) | — | handleDelete (AccountSettings.tsx:537-553) fires DELETE /api/settings/constitution on click with ze… |
...
| [ISS-326](../.knowledge/cards/20260828-ISS-326.md) | [FIX-388](../.knowledge/cards/20260829-0053-FIX-388.md) | — | WorkflowDialog declares role="dialog"/aria-modal but has zero Escape/onKeyDown handling; only the C… |
...
| [ISS-331](../.knowledge/cards/20260828-1840-ISS-331.md) | [FIX-395](../.knowledge/cards/20260829-0338-FIX-395.md) | — | CONFIRMED: HookDetailModal.handleCopy (LibraryPage.tsx:351-355) awaits writeText with no catch — an… |
...
| [ISS-345](../.knowledge/cards/20260828-1900-ISS-345.md) | [FIX-400](../.knowledge/cards/20260829-0402-FIX-400.md) | — | WorkflowView.tsx onClick={() => setAttachedFiles(...)} at the chip remove button (~line 388) only f… |
...
| [ISS-500](../.knowledge/cards/20260829-0006-ISS-500.md) | [FIX-394](../.knowledge/cards/20260829-0127-FIX-394.md) | [ISS-332](../.knowledge/cards/20260828-2041-ISS-332.md) | INFERRED sibling of ISS-332: the same broken FileTreeNode/footer ships unmodified to PreviewPanel.t… |
...
| [ISS-555](../.knowledge/cards/20260829-0208-ISS-555.md) | [FIX-395](../.knowledge/cards/20260829-0338-FIX-395.md) | — | SkillDetailModal.handleCopy (LibraryPage.tsx:201-205) has the identical unguarded await-writeText-n… |
...
| [ISS-561](../.knowledge/cards/20260829-0208-ISS-561.md) | [FIX-395](../.knowledge/cards/20260829-0338-FIX-395.md) | — | handleCopyInstall (L73-78) and the API-key copy button (L316-323) both use .then() with no .catch; … |
...
| [ISS-583](../.knowledge/cards/20260829-0234-ISS-583.md) | [FIX-400](../.knowledge/cards/20260829-0402-FIX-400.md) | [ISS-345](../.knowledge/cards/20260828-1900-ISS-345.md) | INFERRED sibling of ISS-345: attach (WorkflowView.tsx:340) appends a NEW marker block per event, jo… |
...
| [ISS-592](../.knowledge/cards/20260829-0117-ISS-592.md) | [FIX-407](../.knowledge/cards/20260829-0441-FIX-407.md), [FIX-423](../.knowledge/cards/20260901-FIX-423.md) | [ISS-360](../.knowledge/cards/20260828-1917-ISS-360.md) | routes.libraryAgent(slug) builds a bare /library/agents/<id> path with no query string; the router.… |
| [ISS-593](../.knowledge/cards/20260829-0117-ISS-593.md) | [FIX-407](../.knowledge/cards/20260829-0441-FIX-407.md), [FIX-423](../.knowledge/cards/20260901-FIX-423.md) | [ISS-360](../.knowledge/cards/20260828-1917-ISS-360.md) | routes.librarySkill(slug) builds a bare /library/skills/<id> path with no query string; the router.… |
| [ISS-594](../.knowledge/cards/20260829-0117-ISS-594.md) | [FIX-407](../.knowledge/cards/20260829-0441-FIX-407.md), [FIX-423](../.knowledge/cards/20260901-FIX-423.md) | — | T16 effect (LibraryPage.tsx:643-665) only clears selectedAgent/Skill/Hook on a URL change; it never… |
...
| [ISS-606](../.knowledge/cards/20260829-1412-ISS-606.md) | [FIX-334](../.knowledge/cards/20260828-2149-FIX-334.md), [FIX-411](../.knowledge/cards/20260829-1646-FIX-411.md) | — | AgentThinkingTab (Steps tab) and FilesTab agent-outputs list get raw agentOutputs/agents/pipelineSt… |
...
| [ISS-617](../.knowledge/cards/20260831-0110-ISS-617.md) | [FIX-323](../.knowledge/cards/20260828-1629-FIX-323.md), [FIX-415](../.knowledge/cards/20260831-0110-FIX-415.md) | — | the three gate tests leaned on inline `gate: Human_Gate` and manifest `gates: [human]`, both of whi… |
...
| [ISS-621](../.knowledge/cards/20260831-0110-ISS-621.md) | [FIX-419](../.knowledge/cards/20260831-0110-FIX-419.md) | — | playwright_smoke_test, claude-sonnet-5 and html-deck-to-pptx each moved a pin nobody bumped; separa… |
| [ISS-625](../.knowledge/cards/20260831-0115-ISS-625.md) | [FIX-424](../.knowledge/cards/20260901-FIX-424.md) | — | no family buckets to ppt so WorkflowHistory drops the chip entirely; whether the runs SHOULD be gon… |
| [ISS-626](../.knowledge/cards/20260831-0115-ISS-626.md) | [FIX-425](../.knowledge/cards/20260901-FIX-425.md) | — | test_a_last_streamed_built_in_refuses_an_append_after_final_step_slot times out on its locator; app… |
| [ISS-627](../.knowledge/cards/20260831-0115-ISS-627.md) | [FIX-423](../.knowledge/cards/20260901-FIX-423.md) | — | ISS-592/593/594/320 pass under xfail(strict) and the S-15-01 Escape pin now fails, so five guards a… |
...
| ~~[ISS-190](../.knowledge/cards/20260828-1501-ISS-190.md)~~ SUPERSEDED (no FIX card landed) | **none found** | [ISS-195](../.knowledge/cards/20260828-1558-ISS-195.md), [ISS-197](../.knowledge/cards/20260828-1559-ISS-197.md) | INFERRED sibling of ISS-190: page.tsx:3701 gates ALL 34 screens on the same mount-once mounted/isAuthenticate… |
...
| [ISS-320](../.knowledge/cards/20260828-1802-ISS-320.md) | [FIX-385](../.knowledge/cards/20260829-0241-FIX-385.md), [FIX-386](../.knowledge/cards/20260831-1020-FIX-386.md), [FIX-423](../.knowledge/cards/20260901-FIX-423.md) | [ISS-480](../.knowledge/cards/20260828-2320-ISS-480.md), [ISS-481](../.knowledge/cards/20260828-2321-ISS-481.md) | deleteSkill (SkillManager.tsx:99-114) wired to onClick:221 fires DELETE with zero confirm, same gap as ISS-320 |
...
| [ISS-247](../.knowledge/cards/20260828-1637-ISS-247.md) | [FIX-346](../.knowledge/cards/20260828-2314-FIX-346.md), [FIX-377](../.knowledge/cards/20260829-0158-FIX-377.md) | [ISS-361](../.knowledge/cards/20260828-2120-ISS-361.md) | INFERRED sibling of ISS-247: LaunchWizard.tsx:1046/583-584/243 wires the same ReviewGatesSection to its own g… |
...
| [ISS-293](../.knowledge/cards/20260828-1924-ISS-293.md) | [FIX-364](../.knowledge/cards/20260829-0041-FIX-364.md) | | _inject_constitution (factory.py:673-699), called from _compose_system_prompt:586 every run, injects the full… |
...
| [ISS-617](../.knowledge/cards/20260831-0110-ISS-617.md) | [FIX-323](../.knowledge/cards/20260828-1629-FIX-323.md), [FIX-415](../.knowledge/cards/20260831-0110-FIX-415.md) | | the agents API and the frontend-consistency check assert gate values FIX-323 deleted from AGENT.md and workfl… |
...
| `backend/agents/execution_engine/engine.py` | stale-state | [ISS-104](../.knowledge/cards/20260812-1312-ISS-104.md) | Multiple in-code citations to shutdown-path line numbers had drifted from the code they described, … |
| `backend/agents/execution_engine/engine.py` | silent-discard | [FIX-BUGFIX-NESTED-REVISION](../.knowledge/cards/20260811-2031-FIX-BUGFIX-NESTED-REVISION.md), ~~[ISS-133](../.knowledge/cards/20260812-2148-ISS-133.md)~~ ESCALATED | Two deferred defects: a second update_specs click at the re-opened gate silently no-ops, and nested… |
...
| round | batches | cards |
|---|---|---|
| 1 | 16 — all concurrent | 93 |
| 2 | 8 — all concurrent | 39 |
| 3 | 3 — all concurrent | 41 |
| 4 | 6 — all concurrent | 31 |
| 5 | 2 — all concurrent | 9 |
| 6 | 1 — all concurrent | 1 |

**30 multi-card batches** carry 208 of the 214 cards.
...
| [backend · api](#backend--api) | 30 | 5 | 1 |
...
| [frontend · routes](#frontend--routes) | 12 | 4 | 1 |
...
| [frontend · lib](#frontend--lib) | 1 | 1 | 6 |
...
|---|---|---|---|
| 1 | **backend · other** | 9 | [ISS-096](../.knowledge/cards/20260812-1120-ISS-096.md), [ISS-130](../.knowledge/cards/20260812-2116-ISS-130.md), [ISS-132](../.knowledge/cards/20260812-2116-ISS-132.md), [ISS-156](../.knowledge/cards/20260813-1300-ISS-156.md), [ISS-173](../.knowledge/cards/20260825-0955-ISS-173.md), [ISS-630](../.knowledge/cards/20260831-0115-ISS-630.md), [ISS-632](../.knowledge/cards/20260831-0115-ISS-632.md), [ISS-634](../.knowledge/cards/20260831-0115-ISS-634.md), [ISS-638](../.knowledge/cards/20260831-0115-ISS-638.md) |
| 1 | `backend/tests/agents/test_phase6_frontend_consistency.py` | 1 | [ISS-079](../.knowledge/cards/20260812-0236-ISS-079.md) |
| 2 | `backend/tests/agents/test_id_alias_resolver.py` | 1 | [ISS-174](../.knowledge/cards/20260825-0956-ISS-174.md) |
| 4 | `backend/agents/execution_engine/engine.py` | 3 | [ADR-0002](../.knowledge/cards/20260811-ADR-0002.md), [FIX-BUGFIX-NESTED-REVISION](../.knowledge/cards/20260811-2031-FIX-BUGFIX-NESTED-REVISION.md), [ISS-094](../.knowledge/cards/20260812-1120-ISS-094.md) |

#### backend · api

30 cards across 5 batch(es).

| round | fix site | cards | members |
|---|---|---|---|
| 1 | **backend · api** | 3 | [ISS-134](../.knowledge/cards/20260812-2140-ISS-134.md), [ISS-419](../.knowledge/cards/20260829-0022-ISS-419.md), ~~[ISS-470](../.knowledge/cards/20260828-2310-ISS-470.md)~~ CLOSED→FIX-441 |
| 1 | `backend/app/api/admin.py` | 2 | [ISS-405](../.knowledge/cards/20260828-2324-ISS-405.md), ~~[ISS-471](../.knowledge/cards/20260828-2310-ISS-471.md)~~ CLOSED→FIX-441 |
| 2 | `backend/app/api/run_commands.py` | 17 | ~~[BUG-004-GROUNDED-CONTEXT](../.knowledge/cards/20260716-1231-BUG-004-GROUNDED-CONTEXT.md)~~ CLOSED→FIX-440, ~~[BUG-017-GROUNDED-CONTEXT](../.knowledge/cards/20260717-1336-BUG-017-GROUNDED-CONTEXT.md)~~ CLOSED, [ISS-100](../.knowledge/cards/20260812-1232-ISS-100.md), [ISS-104](../.knowledge/cards/20260812-1312-ISS-104.md), [ISS-119](../.knowledge/cards/20260812-1612-ISS-119.md), [ISS-127](../.knowledge/cards/20260812-2045-ISS-127.md), [ISS-128](../.knowledge/cards/20260812-2046-ISS-128.md), ~~[ISS-133](../.knowledge/cards/20260812-2148-ISS-133.md)~~ ESCALATED, ~~[ISS-144](../.knowledge/cards/20260813-0205-ISS-144.md)~~ CLOSED→FIX-247, [ISS-154](../.knowledge/cards/20260813-0819-ISS-154.md), [ISS-161](../.knowledge/cards/20260813-1300-ISS-161.md), [ISS-398](../.knowledge/cards/20260828-2106-ISS-398.md), [ISS-418](../.knowledge/cards/20260828-2231-ISS-418.md), [ISS-422](../.knowledge/cards/20260829-0027-ISS-422.md), [ISS-435](../.knowledge/cards/20260828-2253-ISS-435.md), [ISS-436](../.knowledge/cards/20260828-2253-ISS-436.md), [ISS-437](../.knowledge/cards/20260828-2253-ISS-437.md) |
...
| 4 | `frontend/src/hooks/useRunChat.ts` | 4 | [BUG-018-GROUNDED-CONTEXT](../.knowledge/cards/20260717-1903-BUG-018-GROUNDED-CONTEXT.md), [BUG-021-GROUNDED-CONTEXT](../.knowledge/cards/20260717-2113-BUG-021-GROUNDED-CONTEXT.md), [ISS-111](../.knowledge/cards/20260812-1444-ISS-111.md), [ISS-141](../.knowledge/cards/20260813-0005-ISS-141.md) |
...
| 2 | **frontend · routes** | 4 | [ISS-376](../.knowledge/cards/20260828-2152-ISS-376.md), [ISS-407](../.knowledge/cards/20260828-2343-ISS-407.md), [ISS-415](../.knowledge/cards/20260828-2202-ISS-415.md), [ISS-442](../.knowledge/cards/20260829-0106-ISS-442.md) |
...
| round | fix site | cards | members |
|---|---|---|---|
| 6 | **frontend · lib** | 1 | [BUG-013-GROUNDED-CONTEXT](../.knowledge/cards/20260716-1935-BUG-013-GROUNDED-CONTEXT.md) |
...
143 cards with no declared sibling and no same-file/same-class neighbour.
...
|  | `backend/agents/execution_engine/engine.py`, `backend/tests/agents/test_spec_revision_cycles.py` | One 'Update the Specs' click still costs four approvals because the redundant in-pass analyze gate firing was identifie… |
...
|  | `backend/agents/execution_engine/engine.py` | Unlike update_specs_eligible, redoable=True is a hardcoded literal at all three gate sites, so any gated agent gets a R… |
...
|  | `backend/agents/capabilities/strategies/wave_scheduler.py` | wave_scheduler catches except Exception to flip a wave row terminal, but CancelledError inherits BaseException so a can… |
...
|  | `backend/agents/capabilities/context_providers/conversation.py` | conversation.py calls unbounded read_events then filters in Python to build a 6-turn transcript, now unconditional on e… |
...
|  | `backend/app/agents/checkpointer.py`, `backend/app/api/run_shutdown.py` | close_checkpointer()'s pool.close() has no timeout, so a slow Postgres pool close can push teardown past the SIGKILL de… |
...
|  | `backend/agents/planner/smart_planner.py`, `backend/tests/conftest.py` | Eight offline tests construct a real LLM provider client (five bypassing build_model) but never invoke it, so they're e… |
...
|  | `backend/agents/capabilities/model_catalog.py`, `backend/app/agents/cached_invoke.py`, `backend/app/agents/deep_agent_runner.py`, `backend/app/core/config.py` | Bedrock prompt caching is one global switch with no per-workflow override; short runs that write cache never re-read pa… |
...
|  | `backend/agents/execution_engine/engine.py` | _stamp_resume_marker reads the entire durable log just to compute the next seq and uses a non-retrying append, carrying… |
...
| ~~[ISS-144](../.knowledge/cards/20260813-0205-ISS-144.md)~~ CLOSED→FIX-247 | `backend/app/api/run_commands.py` | POST /answers has no terminal-run 409 guard unlike /gate, though the needed helper is already imported — a cancelled ru… |
...
|  | `backend/app/api/_workflow_override.py` | The UI no longer offers the blank template, but rows already storing custom-agent:<id> are untouched and keep failing a… |
...
|  | `backend/agents/workflows/ppt/workflow.yaml`, `backend/app/agents/skill_staging.py` | The composer hunts for template files at the skill mount point while the real files sit at /references/, burning turns;… |
...
|  | `backend/tests/unit/test_register_password_echo.py` | The fixture builds its own FastAPI() and includes only auth_router, so app.main's RequestValidationError handler never … |
...
| ~~[ISS-470](../.knowledge/cards/20260828-2310-ISS-470.md)~~ CLOSED→FIX-441 | `backend/app/api/settings.py` | Same commit-then-refresh(row) shape as ISS-319: a concurrent PUT could report the OTHER PATs github_username/scopes as … |
...
|  | `backend/agents/workflows/prototype_revision/workflow.yaml`, `backend/tests/agents/test_manifest_coverage.py`, `backend/tests/agents/test_registry.py` | roster and compiled sequence diverge from the manifest for all three revision pipelines; 15 tests witness what looks li… |
...
|  | `backend/agents/workflows/playwright_smoke_test/workflow.yaml`, `backend/tests/agents/test_id_alias_resolver.py`, `backend/tests/agents/test_manifest_parity.py` | the spec-018 manifest declares planner: skip where parity requires run, and its clarify.defaults is empty where the eng… |
|  | `backend/tests/unit/test_alembic.py` | test_upgrade_then_check_reports_no_drift raises AutogenerateDiffsDetected: the ORM metadata and the migration chain hav… |
