...
**208 open cards → 199 units of work** (46 families + 153 singletons), schedulable as **40 work batches** — see [Work batches](#work-batches--how-to-actually-run-this) for the execution view. **198 closed** — see [Closed](#-closed--fix-landed).
...
198 defect card(s) now `status: resolved`. Kept here so this one file
...
| round | fix site | cards | members |
|---|---|---|---|
| 1 | **backend · api** | 3 | [ISS-134](../.knowledge/cards/20260812-2140-ISS-134.md), [ISS-419](../.knowledge/cards/20260829-0022-ISS-419.md), [ISS-470](../.knowledge/cards/20260828-2310-ISS-470.md) |
